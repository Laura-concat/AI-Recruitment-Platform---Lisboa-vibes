# Recruitment AI Tool - Parallel Development Guide
...
# 1. Merge epic #1
git merge epic/1-candidate-profile-management

# 2. Merge task #2
#    (depends on: #7)
git merge task/2-implement-cv-uploader

# 3. Merge task #3
#    (depends on: #7)
git merge task/3-develop-ai-profile-analysis

# 4. Merge epic #4
git merge epic/4-job-posting-and-matching

# 5. Merge task #5
#    (depends on: #7)
git merge task/5-create-job-description-uploader
...
- [GitHub Issues](https://github.com/Laura-concat/AI-Recruitment-Platform---Lisboa-vibes/issues) - View all issues with detailed requirements
